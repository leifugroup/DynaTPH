...
Welcome to the DynaTPH dataset repository! **This Github repository contains a lightweight version of the DynaTPH dataset** and filtering scripts for building the dataset.
